...
public interface StudentDAO {
        ...
        void updateStudent(StudentDTO studentDTO, int id) throws SQLException, ClassNotFoundException;
        void removeStudent(int id) throws SQLException, ClassNotFoundException;
